      ...
      html: `
                <div class="p-2">
                    <div class="mb-4">
                        ...
                        <input id="swal-input1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500 transition-all duration-300" placeholder="Task title" value="${
                          task.title
                        }">
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea id="swal-input2" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500 transition-all duration-300 h-24" placeholder="Task description">${
                          task.description
                        }</textarea>
                    </div>
                    <div class="mb-2">
