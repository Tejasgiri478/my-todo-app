          ...
          {userToken ? (
            <div className="flex items-center justify-center">
              <p className="mr-5 text-white">
                Welcome,{" "}
                <span className="text-xl text-yellow-300 capitalize font-semibold">
                  {user?.name || "User"}
                </span>
              </p>
              <button
                onClick={logout}
                className="logout mr-4 px-4 py-1.5 bg-red-500 text-white rounded-full hover:bg-red-600 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Logout
              </button>
            </div>
