...
function Login() {
  ...
  return (
    <div>
      <section className="login-container min-h-screen overflow-y-auto overflow-x-hidden flex items-center justify-center">
        <div className="container px-2 sm:px-6 py-6">
          <div className="flex justify-center items-center mx-auto flex-wrap text-gray-800 gap-8 relative">
            <div className="md:w-8/12 lg:w-5/12 auth-image-container px-6 flex justify-center">
              <img
                ...
                <>
                  <div className="flex flex-col items-center w-full max-w-md">
                    <div className="flex flex-col items-center mb-4">
                      <div className="inline-block p-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full mb-3 shadow-lg transform transition-all duration-500 hover:scale-110">
                      ...
                      <p className="text-gray-500 font-light">Log in to manage your tasks</p>
                    </div>
                    ...
                    >
                      {error && (
                        <div
                          className="flex items-center bg-red-100 border border-red-400 text-red-700 px-2 py-1 rounded mb-2 relative text-sm"
                          role="alert"
                        >
                      ...
                      {success && (
                        <div
                          className="flex items-center bg-green-100 border border-green-400 text-green-700 px-2 py-1 rounded mb-2 relative text-sm"
                          role="alert"
                        >
                      ...
                      <div className="mb-4">
                        ...
                        >
                          <EmailIcon className="mr-1 text-blue-500" fontSize="small" />
                          Email Address
                        </label>
                        <input
                          type="email"
                      ...
                      <div className="mb-4 relative">
                        <label
                          ...
                          className="block text-sm font-medium text-gray-700 mb-1 flex items-center"
                        >
                          <LockIcon className="mr-1 text-blue-500" fontSize="small" />
                          Password
                        </label>
                      ...
                      <div className="flex items-center my-3 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
                        <p className="text-center font-semibold mx-4 mb-0 text-sm">
                          Or
                        </p>
                      </div>
                    ...
                    >
                      {resetMessage && (
                        <div
                          ...
                          } border px-2 py-1 rounded mb-2 relative text-sm`}
                          role="alert"
                        >
                          {resetMessage.type === "success" ? (
                            <CheckCircleIcon className="mr-1 text-sm" />
